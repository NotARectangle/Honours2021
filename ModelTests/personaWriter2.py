...
#persona = "PICARD:"
    ...
    personaId = ["<bos>"] + personaIDs[persona]
    newData = {"PersonaID": personaId, "utterances": utterances}
    print(len(newData["utterances"]))
    newDict[persona] = newData

with open('../Dataset/tngPersonaData.json', 'w', encoding='utf-8') as json_file:
